...
local url,res = https.request('https://mode-pro.tk/xBLACKx/Johoin.php?id='..msg.sender_user_id_)
...
local UserName = (data.username_ or "TEM_BLACK1")
...
if text == ("رفع مطور ثانوي") and tonumber(msg.reply_to_message_id_) ~= 0 and BLACKDevSou(msg) then
function Function_BLACK(extra, result, success)
...
if text and text:match("^رفع مطور ثانوي @(.*)$") and BLACKDevSou(msg) then
...
if text and text:match("^رفع مطور ثانوي (%d+)$") and BLACKDevSou(msg) then
...
if text == ("رفع مطور") and tonumber(msg.reply_to_message_id_) ~= 0 and DevBLACK(msg) then
function Function_BLACK(extra, result, success)
...
if text and text:match("^رفع مطور @(.*)$") and DevBLACK(msg) then
...
if text and text:match("^رفع مطور (%d+)$") and DevBLACK(msg) then
...
send(msg.chat_id_, msg.id_,"• العضو > ["..data.first_name_.."](t.me/"..(data.username_ or "TEM_BLACK1")..")".."\n• تم رفعه "..RTPA.." هنا\n")
...
if BLACKrt == "مميز" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"• العضو > ["..result.title_.."](t.me/"..(text1[3] or "TEM_BLACK1")..")".."\n• تم رفعه "..text1[2].." هنا")   
database:sadd(bot_id.."Special:User"..msg.chat_id_,result.id_)  
...
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'TEM_BLACK1')..')'
...
if text==("عدد المجموعة") and Addictive(msg) and GetSourseMember(msg) then     
if msg.can_be_deleted_ == false then 
...
if text == (database:get(bot_id.."Name:Bot") or "بلاك") and GetSourseMember(msg) then      
...
لعبة رياضيات >> رياضيات
 ...
 لعبة بات >> بات
•━━━━━━• 
- Ch [BLACK - SoUrCe](https://t.me/TEM_BLACK1)
]]
...
if text == "تنظيف المجموعةات" and DevBLACK(msg) then
...
os.execute('wget https://raw.githubusercontent.com/jokerrr7/main/BLACK.lua')
os.execute('wget https://raw.githubusercontent.com/jokerrr7/main/start.lua')
dofile('BLACK.lua')  
return false
end
if text == "راسلني" then
...
send(msg.chat_id_, msg.id_, t..' ●○━━━━━BLACK━━━━━○●\n• اضغط على الاسم ليتم نسخه')
end
...
ge = https.request('https://mode-pro.tk/ageApi/BLACKapi.php?age='..URL.escape(Textage)..'')
ag = JSON.decode(ge)
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '•  BLACK  .',url="t.me/TEM_BLACK1"}},
}
local msg_id = msg.id_/2097152/0.5
...
if DevBLACK(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/DEV-NAG/files_BLACK/main/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/DEV-NAG/files_BLACK/main/files_BLACK/"..file)
if res == 200 then
...
Text = "[𝘞𝘦𝘭𝘤𝘰𝘮𝘦 𝘵𝘰 black 𝘚𝘰𝘶𝘳𝘤𝘦](t.me/TEM_BLACK1)"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'black 𝘚𝘰𝘶𝘳𝘤𝘦 .',url="https://t.me/TEM_BLACK1"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end
if text == 'عايز بوت' or text == 'عايز مطور' or text == 'خوش سورس' or text == 'سورس بلاك' or text == 'عايز بوت تمبلر' or text == 'سورس بلاك' then
Text = [[
...
if text == 'عايز انصب بوت' or text == 'عجبني البوت' or text == 'منو منصبلك' or text == 'منو مطور السورس' or text == 'مطور السورس' or text == 'انصبلك'  or text == 'انصبلك بوت' then
Text = [[
اهلا عزيزي
...
if text == '@eljo_ker_m' or text == '@TEM_BLACK1' or text == 'مودي البدراني' then
Text = [[
...
{'تنظيف المجموعةات •','تنظيف المشتركين •'},
...
inline = {
{{text = '•  BLACK  .',url='http://t.me/TEM_BLACK1'}},
}
